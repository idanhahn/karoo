...
Rachel now held the NRO’s premiere gisting post – intelligence liaison to the White House. She was responsible for sifting through the NRO’s daily intelligence reports, deciding which stories were relevant to the President, distilling those reports into single-page briefs, and then forwarding the synopsized material to the President’s National Security Adviser. In NRO-speak, Rachel Sexton ‘manufactured finished product and serviced the customer.’

Although the job was difficult and required long hours, the position was a badge of honor for her, a way to assert her independence from her father. Senator Sexton had offered countless times to support Rachel if she would quit the post, but Rachel had no intention of becoming financially beholden to a man like Sedgewick Sexton. Her mother was testimony to what could happen when a man like that held too many cards.
...
The ultimate surveillance tool, Delta-One thought, still amazed every time they powered it up. Lately, in the world of micromechanics, fact seemed to be outpacing fiction.
...
Although microscopic, remote-controlled robots sounded like science fiction, in fact they had been around since the 1990s. Discovery magazine had run a cover story in May 1997 on microbots, featuring both ‘flying’ and ‘swimming’ models. The swimmers – nanosubs the size of salt grains – could be injected into the human bloodstream à la the movie Fantastic Voyage. They were now being used by advanced medical facilities to help doctors navigate arteries by remote control, observe live intravenous video transmissions, and locate arterial blockages without ever lifting a scalpel.

Contrary to intuition, building a flying microbot was an even simpler business. The aerodynamics technology for getting a machine to fly had been around since Kittyhawk, and all that remained had been the issue of miniaturization. The first flying microbots, designed by NASA as unmanned exploration tools for future Mars missions, had been several inches long. Now, however, advances in nanotechnology, lightweight energy-absorbent materials, and micromechanics had made the flying microbots a reality.
...
He pointed toward the end of the runway. Rachel saw the mammoth shape glistening in the distance, and her heart almost stopped. Even at 300 yards, she recognized the light blue hull of the modified 747.
...
‘Certainly am.’ He grinned. ‘Forget about this CNN debate. Worse case scenario, the White House snubs me by sending some low-level campaign intern. Best case scenario, they send a bigwig, and I eat him for lunch.’
...
The words hung a moment in the air before Rachel could process them. A NASA discovery? Recent intelligence updates had suggested nothing out of the ordinary going on with the space agency. Of course, these days a ‘NASA discovery’ usually meant realizing they’d grossly underbudgeted some new project.
...
A more pointed issue between the agencies, however, was the fact that because NASA handled the NRO’s satellite launches, many of NASA’s recent failures directly affected the NRO. No failure had been more dramatic than that of 12 August 1998, when a NASA/Air Force Titan 4 rocket blew up forty seconds into launch and obliterated its payload – a $1.2 billion NRO satellite code-named Vortex 2. Pickering seemed particularly unwilling to forget that one.
...
‘You have a skeptical look on your face,’ the President said, eying her askance.
...
The President looked quietly amused. ‘Rachel, think you’ll find this discovery far more intriguing than science fiction.’
...
As Rachel’s vision cleared, she found herself standing face to face with a young, stone-jawed buck in a NASA flight suit. His body was fit and muscle-bound, his chest bedecked with countless patches.
...
By the time the Tomcat leveled out at 45,000 feet, Rachel was feeling queasy. She willed herself to focus her thoughts elsewhere. Gazing down at the ocean nine miles below, Rachel felt suddenly far from home.
...
His secretary glanced up. ‘Your entire staff, sir? All one hundred and forty-five of them?’
...
Because Delta Force missions usually involve high levels of secrecy, the traditional multitiered chain of command is often circumvented in favor of ‘monocaput’ management – a single controller who holds authority to control the unit as he or she sees fit. The controller tends to be a military government powerbroker with sufficient rank or influence to run the mission. Regardless of the identity of their controller, Delta Force missions are classified at the highest level, and once a mission is completed, Delta Force soldiers never speak of it again – not to one another, and not to their commanding officers within Special Ops.

Fly. Fight. Forget.

The Delta team currently stationed above the 82nd Parallel was doing no flying or fighting. They were simply watching.
...
Rachel had seen icebergs only once before in her life, six years ago when her mother persuaded Rachel to join her on an Alaskan mother-daughter cruise. Rachel had suggested countless alternative land-based vacations, but her mother was insistent. ‘Rachel, honey,’ her mother had said, ‘two thirds of this planet is covered with water, and sooner or later, you’ve got to learn to deal with it.’ Mrs Sexton was a resilient New Englander intent on raising a strong daughter.
...
As they passed below 3,000 feet, Rachel stared out at the dramatic moonlit terrain beneath them. At the base of the mountains, an expansive, snowy plain swept wide. The plateau spread gracefully seaward about ten miles until it ended abruptly at a sheer cliff of solid ice that dropped vertically into the ocean.
...
‘Please unhook your flight harness, leave your helmet in the craft, and deplane by using the fuselage toeholds. Do you have any questions?’
...
The Milne Ice Shelf is the largest solid ice floe in the Northern Hemisphere. Located above the 82nd Parallel on the northernmost coast of Ellesmere Island in the high Arctic, the Milne Ice Shelf is 4 miles wide and reaches thicknesses of over three hundred feet.
...
Rachel could only stare. I traveled 3,000 miles for this kind of hospitality? This guy was no Martha Stewart. ‘With all due respect,’ she fired back, ‘I am also under presidential orders. I have not been told my purpose here. I made this trip on good faith.’
...
She followed the administrator down the narrow corridor, where they dead-ended at a heavy, black drapery. Beyond the drape, Rachel could hear the reverberant murmur of countless voices rumbling on the other side, echoing as if in a giant open space.
...
The administrator led Rachel toward a series of tables where a lone man sat at a computer work station. He was dressed in a black turtleneck, wide-whale corduroys, and heavy boat shoes, rather than the matching NASA weather gear everyone else seemed to be wearing. He had his back to them.
...
Michael Tolland was visibly embarrassed. ‘Ms Sexton, please excuse Mr Marlinson. What he lacks in tact, he more than makes up for in random bits of totally useless knowledge about our universe.’
...
‘Nor will you!’ Corky declared. ‘Chondrules are one geologic structure we simply do not have on earth. Some chondrules are exceptionally old – perhaps made up of the earliest materials in the universe. Other chondrules are much younger, like the ones in your hand. The chondrules in that meteorite date only about one hundred and ninety million years old.’
...
The appearance certainly was not earth-shattering. Like the sample she had seen earlier, it was an orangish-white, heavy rock. Part of the rim was charred and black, apparently a segment of the meteorite’s outer skin. ‘I see the fusion crust,’ she said.
...
‘It’s . . .’ Rachel stammered, almost unable to speak theword. ‘It’s . . . a bug! This meteorite contains the fossil of a bug!’
...
Sexton’s eyes narrowed. Nice try, lady.‘Iamnot anti-NASA, and I resent the accusation. I am simply saying that NASA’s budget is indicative of the kind of runaway spending that your President endorses. NASA said they could build the shuttle for five billion; it cost twelve billion. They said they could build the space station for eight billion; now it’s one hundred billion.’
...
Sexton rolled his eyes. ‘Oh, for heaven’s sake, Ms Tench, if I’m wrong I’ll eat my hat.’
...
‘See those bore holes in the ice under the tripod?’ Norah asked, pointing, her initial put-out tone softening now to one of rapt fervor for her work.
...
‘That’s a gallium arsennide semiconductor laser,’ Norah said.
...
Rachel crouched down and could indeed see that the tube was made up of what appeared to be countless strata of ice with subtle differences in luminosity and clarity. The layers varied between paper thin to about a quarter of an inch thick.
...
‘And coincidentally,’ Norah said, ‘1716 is the exact year early explorers claimed to have seen a bright fireball in the sky over northern Canada. The meteor became known as the Jungersol Fall, after the name of the exploration’s leader.’
...
The office of Senator Sedgewick Sexton was located in the Philip A. Hart Senate Office Building on C Street to the northeast of the Capitol. The building was a neomodern grid of white rectangles that critics claimed looked more like a prison than an office building. Many who worked there felt the same.
...
Although Rachel Sexton was currently sitting inside a large metal box situated 3,000 miles from Washington, D.C., she felt the same pressure as if she’d been summoned to the White House. The videophone monitor before her displayed a crystal clear image of President Zach Herney seated in the White House communications room before the presidential seal. The digital audio connection was flawless, and with the exception of an almost imperceptible delay, the man could have been in the next room.
...
‘Hold on!’ Herney waved his hands in surrender. ‘Who said anything about a public forum?’
...
Rachel felt trapped inside the tiny PSC trailer. Nothing like the hard sell. Even from 3,000 miles away, Rachel could feel the strength of his will pressing through the video screen. She also knew this was a perfectly reasonable request, whether she liked it or not.
...
Up ahead he saw the extraction shaft – the point from which the most magnificent fossils in all of human history had been taken. The giant metal tripod had now been stowed and the pool sat alone, surrounded by pylons like some kind of shunned pothole on a vast parking lot of ice. Ming wandered over to the pit, standing a safe distance back, peering into the 200-foot-deep pool of frigid water. Soon it would refreeze, erasing all traces that anyone had ever been here.
...
‘Because,’ Tolland said, ‘the meteorite was buried in glacial ice – freshwater from snowfalls. The water in that hole is glacial melt and has been frozen for three centuries. How could ocean creatures get in there?’
...
Tolland stroked his chin as he watched the phosphorescing creatures. ‘There’s literally no other explanation. There must be a crack. The weight of the ice shelf on top of the ocean must be pushing plankton-rich seawater up into the hole.’

One hell of a crack, Rachel thought. If the ice here was 300 feet thick and the hole was 200 feet deep, then this hypothetical crack had to pass through 100 feet of solid ice. Norah Mangor’s test cores showed no cracks.
...
Gabrielle Ashe had taken the White House public tour countless times in her youth, secretly dreaming of someday working inside the presidential mansion, and becoming part of the elite team that charted the country’s future. At the moment, however, she would have preferred to be anywhere else in the world.
...
‘Logical?’ Norah rolled her eyes. ‘You know, for a prize-winning physicist and a world-famous oceanographer, you’re a couple of pretty dense specimens. Has it occurred to you that even if there is a crack – which I can assure you there is not – it is physically impossible for any seawater to be flowing into this shaft.’ She stared at both of them with pathetic disdain.
...
Rachel nodded. ‘You showed northern pike that got frozen in lakes and had to wait until the thaw to swim away. You also talked about microorganisms called “waterbears” that became totally dehydrated in the desert, remained that way for decades, and then re-inflated when rains returned.’
...
Norah glared. ‘You and space boy shouldn’t be out here.’
...
As soon as the train exited the tunnel and climbed onto the above-ground tracks near L’Enfant Plaza, Gabrielle dug out her cellphone and called the senator’s private cellular number. His voice mail answered. Puzzled, she phoned the senator’s office. The secretary answered.
...
Tolland now felt the ice ripping beneath his padded suit with relentless acceleration, and the relief at having escaped faded fast. Less than two miles directly ahead of them, the Milne Ice Shelf came to an abrupt end at a precipitous cliff – and beyond it . . . a 100-foot drop to the lethal pounding surf of the Arctic Ocean.
...
Fighting in desperation with their harnesses, Rachel tried to find a way to release the balloon. It was then that she heard the rhythmic ticking on the ice – the rapid-fire staccato of lightweight metal on the sheet of bare ice. The ax.
...
‘Leave the folder,’ he said. ‘I’ll take it in to him.’
...
The wrenching yank on her harness expelled what little air Rachel had left in her lungs. She jerked to a dead stop only yards from the edge. The motion spun her in space. Ten yards away, she could see Corky’s limp body, still tethered to her, also jolting to a stop. They had been flowing off the sheet in opposite directions and his momentum had stopped her. As the water ran off and grew more shallow, another dark form appeared over near Corky. He was on his hands and knees, grasping Corky’s tether and vomiting saltwater.
...
Senator Sedgewick Sexton set his snifter of Courvoisier on the mantelpiece of his Westbrooke apartment and stoked the fire for several moments, gathering his thoughts. The six men in the den with him sat in silence now . . . waiting. The small talk was over. It was time for Senator Sexton to make his pitch. They knew it. He knew it.
...
‘Hey, Lawrence?’ Herney’s voice grew low and solemn now. ‘You’ve done a hell of thing up there. I won’t ever forget it.’
...
When the submarine’s captain arrived in the sonar room, the technician piped a live sonar feed over a small set of speakers. The captain listened, expressionless.
...
A telephone rang sharply behind her, shattering the silence of the hallway. Startled, Gabrielle turned. The sound was coming from the closet in the foyer – a cellphone in the pocket of one of the visitor’s coats.
...
Tench’s cold eyes stared, and she held out a spiderlike hand. ‘Give me the phone.’
...
‘A fake meteorite?’ Corky gave an awkward laugh. ‘Utterly impossible! That meteorite was examined by countless professionals. Myself included. Chemical scans, spectrograph, rubidium-strontium dating. It is unlike any kind of rock ever seen on earth. The meteorite is authentic. Any astrogeologist would agree.’
...
‘Specifically?’ Corky’s voice cracked in the headphones. ‘A flawless fusion crust, the presence of chondrules, a nickel ratio unlike anything ever found on earth. If you’re suggesting that someone tricked us by manufacturing this rock in a lab, then all I can say is that the lab was about one hundred and ninety million years old.’ Corky dug in his pocket and pulled out a stone shaped like a CD. He held it in front of the camera. ‘We chemically dated samples like this with numerous methods. Rubidium-strontium dating is not something you can fake!’
...
‘As there should be. They love Zach Herney, and they were losing faith. You’ve got to admit, the President was lying down and taking some pretty big hits recently, but he’s come out of it smelling like a rose.’
...
‘You’ve got to admit,’ Yolanda said, ‘the White House played Sexton brilliantly – hurling him down the NASA path, getting him to commit, coaxing him to put all his eggs in the NASA basket.’
...
The thundering navy SeaHawk chopper had been scrambled under a covert operation status out of Thule Air Force Base in northern Greenland. It stayed low, out of radar range, as it shot through the gale winds across seventy miles of open sea. Then, executing the bizarre orders they had been given, the pilots fought the wind and brought the craft to a hover above a preordained set of coordinates on the empty ocean.

‘Where’s the rendezvous?’ the copilot yelled, confused. They had been told to bring a chopper with a rescue winch, so he anticipated a search-and-retrieve operation. ‘You sure these are the right coordinates?’ He scanned the choppy seas with a search light, but there was nothing below them except—
...
Gabrielle stood up, unable to imagine what Sexton could be talking about. This is hardly the reaction she had expected.
...
‘I will do whatever necessary,’ Tench declared, ‘to protect the President from false accusations. The mere implication of foul play will cast a heavy shadow on the White House and NASA. Rachel Sexton has abused the trust the President gave her, and I have no intention of seeing the President pay the price.’
...
Yolanda shook her head. ‘Sexton is sending you into a hornets’ nest on a desperate pipe dream. Don’t go. You don’t owe him a thing.’
...
‘Of course,’ Tolland replied. ‘What else could conclude? It’s a far greater leap to assert you’ve found extraterrestrial life than it is to assert you’ve found a fossil of some previously undiscovered terrestrial species. Scientists discover dozens of new species every year.’

‘Two-foot-long lice?’ Corky demanded, sounding incredulous. ‘You would assume a bug that big is from earth?’

‘Not now, maybe,’ Tolland replied, ‘but the species doesn’t necessarily have to be currently living. It’s a fossil. It’s one hundred and seventy million years old. About the same age as our Jurassic. A lot of prehistoric fossils are over-sized creatures that look shocking when we discover their fossilized remains – enormous winged reptiles, dinosaurs, birds.’
...
‘Sure, it did. And it still does, in fact. People eat them every day. They’re a delicacy in most countries.’
...
Tolland felt the directness of her gaze and sensed the true weight of her question. ‘Hypothetically, I would have to say yes. The ocean floor has sections that are one hundred and ninety million years old. The same age as the fossils. And theoretically the oceans could have sustained life-forms that looked like this.’
...
‘Although . . .’ Tolland added. Rachel had him thinking now. ‘I’ll admit there are very deep parts of the ocean floor that oceanographers call dead zones. We don’t really understand them, but they are areas in which the current and food sources are such that almost nothing lives there. Just a few species of bottom-dwelling scavengers. So from that standpoint, suppose a single-species fossil is not entirely out of the question.’
...
The structure housing the NASA central headquarters was a mammoth glass rectangle located at 300 E Street in Washington, D.C. The building was spidered with over 200 miles of data cabling and thousands of tons of computer processors. It was home to 1,134 civil servants who oversee NASA’s $15 billion annual budget and the daily operations of the 12 NASA bases nationwide.

Despite the late hour, Gabrielle was not at all surprised to see the building’s foyer filling with people, an apparent convergence of excited media crews and even more excited NASA personnel. Gabrielle hurried inside. The entryway resembled a museum, dominated dramatically by fullsize replicas of famous mission capsules and satellites suspended overhead. Television crews were staking claims on the expensive marble floor, seizing wide-eyed NASA employees who came through the door.
...
Administrator Ekstrom was too preoccupied with this new information to notice that the storm outside the habisphere was raging harder now. The howling cables had increased in pitch, and the NASA staff was nervously milling and chatting rather than going to sleep. Ekstrom’s thoughts were lost in a different storm – an explosive tempest brewing back in Washington. The last few hours had brought countless problems, all of which Ekstrom was trying to deal with. And yet one problem now loomed larger than all the others combined.
...
Rachel was quiet now, staring blankly at the cabin of the G4 as the plane headed south along the Canadian coastline of the Gulf of St Lawrence. Tolland sat nearby, talking to Corky. Despite the majority of evidence suggesting the meteorite was authentic, Corky’s admission that the nickel content was ‘outside the pre-established midrange values’ had served to rekindle Rachel’s initial suspicion. Secretly planting a meteorite beneath the ice only made sense as part of a brilliantly conceived fraud.
...
Rachel nodded. ‘All you need is a one-hundred-and-ninety-million-year-old fossilized rock. Blast it in a slush-hydrogen-engine exhaust fire, and bury it in the ice. Instant meteorite.’
...
Corky sighed. ‘Chondrules form when a rock, chilled in space, suddenly becomes superheated to a partial-melt stage – somewhere near 1,550 Celsius. Then the rock must cool again, extremely rapidly, hardening the liquid pockets into chondrules.’
...
‘A ridiculous one,’ Corky replied, flashing his meteorite sample. ‘Perhaps you forget? These chondrules were irrefutably dated at one hundred and ninety million years.’ His tone grew patronizing. ‘To the best of my knowledge, Ms Sexton, one hundred and ninety million years ago, nobody was running slush-hydrogen engines and cryogenic coolers.’
...
‘Yeah. She said the only people who would notice the mistake were a few other geologists. It sounds like whatever error I made was relating to the composition of the meteorite itself.’
...
Delta-Two turned to the left side avionics compartment and activated the laser designator. He aimed, and 2,000 feet below, a pinpoint of light appeared on the roof of the sedan, invisible to the occupant. ‘Target painted,’ he said.
...
The plane taxied to a stop, and Rachel and the others climbed out onto a barren runway. The night was overcast, but the coastal air felt heavy and warm. In comparison to Ellesmere, New Jersey felt like the tropics.
...
Rachel was already feeling tense as she buckled herself in beside Tolland. The Aerospatiale engine overhead shrieked to life, and the Dolphin’s sagging 39-foot rotors began to flatten out into a silver blur. The whine turned to a roar, and it lifted off the runway, climbing into the night.
...
The Coast Guard Dolphin was still two miles from the Goya’s coordinates and flying at 3,000 feet when Tolland yelled up to the pilot.
...
Tolland gave a coy smile. ‘Sphyrna mokarran love warm water, and right now, every last one for a hundred miles is congregating in this milewide circle of heated ocean.’
...
Tolland smiled. Despite Rachel’s attempts to be light-hearted, he could tell she was extremely apprehensive about being out here. He wanted to put an arm around her and reassure her, but he knew there was nothing he could say. ‘The lights are on for security. Makes the ship look active.’
...
Tolland tossed the bloody fish overboard and it fell thirty feet. The instant it hit the water, six or seven sharks darted in a tumbling ferocious brawl, their rows of silvery teeth gnashed wildly at the bloody fish. In an instant, the fish was gone.
...
Gabrielle paid the amount on the meter and added $10. ‘Can you wait ten minutes?’
...
‘No names. I can set up a meeting. They’re smart. They understand campaign finance law . . .’ Yolanda hesitated. ‘You know, these guys actually believe Sexton is hurting for cash – bankrupt even.’
...
Dialing Pickering’s private number, she waited, clutching the SHINCOM 2100 receiver to her ear. She expected Pickering to pick up on the first ring. But the line just kept ringing.
...
At fifteen miles out, still safely out of radar range, Delta-One abruptly turned the Kiowa 35 degrees off course to the west. He climbed to 3,000 feet – small airplane range – and adjusted his speed to 110 knots.
...
‘There are some subtle differences,’ Tolland said, scrolling down to some anatomical diagrams and sketches. ‘But it’s damn close. Especially considering it has had one hundred and ninety million years to evolve.’

Close is right, Rachel thought. Too close.

Tolland read the description on the screen: ‘“Thought to be one of the oldest species in the ocean, the rare and recently classified species Bathynomous giganteus is a deepwater scavenging isopod resembling a large pill bug. Up to two feet in length, this species exhibits a chitonous exoskeleton segemented into head, thorax, abdomen. It possesses paired appendages, antennae, and compound eyes like those of land-dwelling insects. This bottom-dwelling forager has no known predators and lives in barren pelagic environments previously thought to be uninhabitable.”’ Tolland glanced up. ‘Which could explain the lack of other fossils in the sample!’

Rachel stared at the creature on-screen, excited and yet uncertain she completely understood what all of this meant.

‘Imagine,’ Tolland said excitedly, ‘that one hundred and ninety million years ago, a brood of these Bathynomous creatures got buried in a deep ocean mud slide. As the mud turns into rock, the bugs get fossilized in stone. Simultaneously, the ocean floor, which is continuously moving like a slow conveyer belt toward the oceanic trenches, carries the fossils into a high-pressure zone where the rock forms chondrules!’ Tolland was talking faster now. ‘And if part of the fossilized, chondrulized crust broke off and ended up on the trench’s accretionary wedge, which is not at all uncommon, it would be in a perfect position to be discovered!’
...
Sexton’s ebullient secretary had apparently glitter-painted some more positive thinking for him for election day. The acronym POTUS was the U.S. Secret Service’s code name for President of the United States. On election day, if all went well, Sexton would become the new POTUS.
...
Tolland didn’t even look up. He pointed to a nearby bulkhead, where an aluminum ramp descended below-decks. Corky apparently needed no encouragement. Keeping his head low, Corky scurried toward the opening and disappeared down the incline. Tolland put a firm arm around Rachel’s waist and followed. The two of them disappeared belowdecks just as the helicopter returned, spraying bullets overhead.
...
A blast of white-hot pain shot through his body as his right foot exploded out from under him by a blistering impact. His balance gone, Delta-Three flailed, tumbling down the stairs. His machine gun clattered down the ramp and went overboard as he collapsed on the catwalk. In anguish, he curled up to grip his right foot, but it was no longer there.
...
She was looking at digital scans of dozens of bank checks written to Sexton from private space companies and deposited in numbered accounts in the Cayman Islands. The smallest check Gabrielle saw was for $15,000. Several were upward of $500,000.

Small potatoes, Sexton had told her. All the donations are under the $2,000 cap.
...
‘Hello,’ Sexton’s outbound message crackled. ‘This is the office of Senator Sedgewick Sexton. If you are trying to send a fax, you may transmit at anytime. If not, you may leave a message at the tone.’
...
He could see she recognized the words – almost a cliché in national security circles. Sacrifice the few to save the many.
...
Pickering took a long look at Rachel and then strode to the ship’s nearby portside railing, staring out at the sea racing by. This was something he preferred not to watch.
...
As the Kiowa’s 300-rpm steel blades collided with the sub’s 15-ton capacity braided-steel winch cable, the night erupted with the shriek of metal on metal. The sounds conjured images of epic battle. From the chopper’s armored cockpit, Delta-One watched his rotors tear into the sub’s cable like a giant lawnmower running over a steel chain. A blinding spray of sparks erupted overhead, and the Kiowa’s blades exploded. Delta-One felt the chopper bottom out, its struts hitting the deck hard. He tried to control the aircraft, but he had no lift. The chopper bounded twice down the inclined deck, then slid, crashing into the ship’s guardrail.
...
Sexton’s eyes bore into her. ‘I made you, Gabrielle, and now I’ve unmade you.’
...
Gabrielle staggered back, feeling her lip split open. She caught herself, grabbing on to the desk, staring up in astonishment at the man she had once worshipped.
...
Now Tolland saw it. The portal lid was not set evenly in the aperture. Like the lid of a jar that had been placed on crooked and screwed down hard, it was stuck. Although the rubber seal was properly set, the hatchdogs were bent, meaning the only way that door was opening was with a welding torch.
...
As the aircraft spiraled downward, its Hellfire missiles still attached, the glowing magma dome waited on the ocean floor like a red-hot landing pad. Beneath its three-meter-thick crust, a head of boiling lava simmered at 1,000 degrees centigrade, a volcano waiting to explode.
...
He looked back toward the Goya, wondering if there were any way to get a winch connected to the Triton to keep it near the surface. Impossible. It was fifty yards away now, and Pickering was standing high on the bridge like a Roman emperor with a prime seat to some bloody Coliseum spectacle.
...
The sub was a good eight feet down now, and the currents and darkness made orienting himself difficult. Once he found the pressurized tank, Tolland quickly rerouted the hose and prepared to pump air into the cockpit. As he gripped the stopcock, the reflective yellow paint on the side of the tank reminded him just how dangerous this maneuver was: CAUTION: COMPRESSED AIR – 3,000 PSI.
...
Even as Tolland and Rachel broke the surface, he knew it was over. The magma dome erupted. As soonasthe top of the vortex reached the surface, the giant underwater tornado would begin pulling everything down. Strangely, the world above the surface was not the quiet dawn he had left only moments ago. The noise was deafening. Wind slashed at him as if some kind of storm had hit while he was underwater.
...
He felt intoxicated as he approached the podium, pleased to see his improvised stage included two ‘fame-frames’ – large, free-standing partitions that flanked his podium like navy-blue curtains – an old Ronald Reagan trick to ensure he stood out against any backdrop.
...
Pasting a broad smile on his face, Sexton turned back to the press and raised an apologetic finger. ‘If you could give me just one minute? I’m terribly sorry.’ He heaved a weary, good-natured sigh. ‘Family first.’
...
Sexton groaned. ‘So naïve. It’s not about winning the election, Rachel, it’s about power. It’s about decisive victory, acts of greatness, crushing opposition, and controlling the forces in Washington so you can get something done.’
...
A howl of feedback echoed out of the PA system behind him, and Sexton wheeled to see a late-arriving female reporter, huddled over his podium, attempting to attach a network microphone to one of the gooseneck clips.
...
Sexton sensed his daughter nearby, standing just offstage behind the partition.
...
Rachel opened the door, disappointed to see a female

U.S. Secret Service agent. She was fit and cute, wearing a blue blazer. ‘Ms Sexton, the gentleman in the Lincoln Bedroom heard your television. He asked me to tell you that as long as you’re already awake . . .’ She paused, arching her eyebrows, clearly no stranger to night games on the upper floors of the White House.
...
Rachel nodded. The legends of ghosts in the Lincoln Bedroom were as old as the White House itself. It was said that Winston Churchill had seen Lincoln’s ghost here, as had countless others, including Eleanor Roosevelt, Amy Carter, actor Richard Dreyfus, and decades of maids and butlers. President Reagan’s dog was said to bark outside this door for hours at a time.
...
Rachel smiled. ‘Thanks.’ She reached for the doorknob, already feeling the anticipation of what lay beyond.
...
Underwater, at 300 feet, barely enough light remained to reveal its tumbling silhouette. Passing 500 feet, the rock plunged into total darkness.
