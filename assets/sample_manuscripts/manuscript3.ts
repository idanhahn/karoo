export const book = {
  ...
  I don’t even know who’l read this. I guess someone wil find it eventualy. Maybe a hundred years from now.
  
  For the record… I didn’t die on Sol 6. Certainly the rest of the crew thought I did, and I can’t blame them. Maybe there’l be a day of
  
  national mourning for me, and my Wikipedia page wil say “Mark Watney is the only human being to have died on Mars.”
  
  And it’l be right, probably. Cause I’l surely die here. Just not on Sol 6 when everyone thinks I did.
  ...
  I wonder if this log wil be recovered before the rest of the crew die of old age? I presume they got back to Earth al right. Wel, guys, if you’re reading this: It wasn’t your fault. You did what you had to do. In your position I would have done the same thing. I don’t blame you, and I’m glad you survived.
  ...
  through an ordinary ship to Hermes. Al the Ares missions use Hermes to get to and from Mars. It’s realy big and cost a lot so NASA only
  ...
  I could regale you with tales of how we had great fun on the trip, but I won’t. We did have fun, but I don’t feel like reliving it right now.
  ...
  vessels in the same general area, and did a reasonably good job. Supplies aren’t nearly so fragile as humans and can hit the ground realy hard. But they tended to bounce around a lot.
  
  Naturaly, they didn’t send us to Mars until they’d confirmed al the supplies had made it to the surface and their containers weren’t
  ...
  hydrogen you bring to Mars, you can make 13 kilograms of fuel. It’s a slow process, though. It takes 24 months to fil the tank. That’s why they sent it long before we got here.
  ...
  with 175 km/hr winds. We al got in our suits and huddled in the middle of the Hab, just in case it lost pressure. But the Hab wasn’t the problem.
  
  The MAV is a spaceship. It has a lot of delicate parts. It can put up with storms to a certain extent but it can’t just get sandblasted
  ...
  only six days but if the MAV took any more punishment we’d al get stranded down here.
  ...
  The storm had abated; I was face down, almost totaly buried in sand. As I groggily came to, I wondered why I wasn’t more dead.
  ...
  After a while, the CO2 (carbon dioxide) absorbers in the suit were expended. That’s realy the limiting factor to life support. Not the
  
  amount of oxygen you bring with you, but the amount of CO2 you can remove. In the Hab, we had the Oxygenator, a large piece of
  
  equipment that could break CO2 apart and give the oxygen back. But the spacesuits had to be portable, so they used a simple chemical
  
  absorption process with expendable filters. I’d been asleep long enough that my filters were useless.
  
  The suit saw this problem and moved in to an emergency mode the engineers cal “bloodletting”. Having no way to separate out the
  
  CO2, the suit deliberately vented air to the Martian atmosphere, then back-filed with nitrogen. Between the breach and the bloodletting, it quickly ran out of nitrogen. Al it had left was my oxygen tank.
  
  So it did the only thing it could to keep me alive. It started back-filing with pure oxygen. I now risked dying from oxygen toxicity, as the excessively high amount of oxygen threatened to burn up my nervous system, lungs, and eyes. An ironic death for someone with a leaky space suit: too much oxygen.
  
  Every step of the way would have had beeping alarms, alerts, and warnings. But it was the high-oxygen warning that woke me.
  
  The sheer volume of training for a space mission is astounding. I spent a week back on Earth practicing emergency space suit drils. I
  
  knew what to do.
  
  Carefuly reaching to the side of my helmet, I got the breach kit. It’s nothing more than a funnel with a valve at the smal end, and an
  ...
  The tricky part was getting the antenna out of the way. I puled it out as fast as I could, wincing as the sudden pressure drop dizzied me and made the wound in my side scream in agony.
  
  I got the breach kit over the hole and sealed it. It held. The suit back-filed the missing air with yet more oxygen. Checking my arm
  
  readouts, I saw the suit was now at 85% oxygen. For reference, Earth’s atmosphere is about 21%. I’d be ok, so long as I didn’t spend too much time like that.
  
  I stumbled up the hil back toward the Hab. As I crested the rise, I saw something that made me very happy and something that made
  
  me very sad: The Hab was in-tact (yay!) and the MAV was gone (boo!).
  
  Right that moment I knew I was screwed. But I didn’t want to just die out on the surface. I limped back to the Hab and fumbled my
  
  way in to an airlock. As soon as it equalized, I threw off my helmet.
  
  Entering the Hab, I doffed the suit and got my first good look at the injury. It would need stitches. Fortunately, al of us had been
  
  trained in basic medical procedures, and the Hab had excelent medical supplies. A quick shot of local anesthetic, irrigate the wound, 9
  
  stitches and I was done. I’d be taking antibiotics for a couple of weeks, but other than that I’d be fine.
  
  I knew it was hopeless, but I tried firing up the communication array. No signal, of course. The primary satelite dish had broken off,
  
  remember? And it took the reception antennae with it. The Hab had secondary and tertiary communication systems, but they were both just
  
  for talking to the MAV, which would use its much more powerful systems to relay to Hermes. Thing is, that only works if the MAV is stil
  ...
  Checking out my suit, I saw the antenna had plowed through my bio-monitor computer. When on an EVA, al the crew’s suits are
  
  networked so we can see each others status. The rest of the crew would have seen the pressure in my suit drop to nearly 0, folowed
  
  immediately by my bio-signs going flat. Add to that I was sent tumbling down a hil with a spear through me in the middle of a sandstorm…
  
  yeah. They thought I was dead. How could they not?
  
  They may have even had a brief discussion about recovering my body, but regulations were clear. In the event a crewman died on
  
  Mars, he stayed on Mars. Leaving his body behind reduced weight for the MAV on the trip back. That meant more disposable fuel and a
  
  larger margin of error for the return thrust. No point in giving that up for sentimentality.
  
  
  
  So that’s the situation. I’m stranded on Mars. I have no way to communicate with Hermes or Earth. Everyone thinks I’m dead. I’m in a
  
  Hab designed to last 31 days.
  
  If the Oxygenator breaks down, I’l suffocate. If the Water Reclaimer breaks down, I’l die of thirst. If the Hab breaches, I’l just kind
  
  of explode. If none of those things happen, I’l eventualy run out of food and starve to death.
  ...
  better ways to grow pot. I didn’t like them. I’ve always been in it for the science, not for any New World Order bulshit.
  ...
  The Hab has sophisticated toilets. Shit is usualy vaccum-dried, then accumulated in sealed bags to be discarded on the surface.
  
  Not any more!
  
  In fact, I even did an EVA to recover the previous bags of shit from before the crew left. Being completely desiccated, this particular
  
  shit didn’t have bacteria in it anymore, but it stil had complex proteins and would serve as useful manure. Adding it to water and active bacteria would quickly get it inundated, replacing any population kiled by the Toilet Of Doom.
  
  I found a big container and filed it with a bit of water, then added the dried shit. Since then, I’ve added my own shit to it as wel. The worse it smels, the more successful things are going. That’s the bacteria at work!
  
  Once I get some Martian soil in here, I can mix in the shit and spread it out. Then I can sprinkle the Earth soil on top. You might not
  ...
  5 square meters was about right for the amount of manure I had handy. I dumped my big container o’ shit on to the soil and nearly
  
  puked from the smel.
  
  That smel’s going to stick around for a while, too. It’s not like I can open a window. Stil, you get used to it. I mixed this soil and shit together with a shovel, and spread it out evenly again. Then I sprinkled the Earth soil on top. Get to work, bacteria. I’m counting on you.
  ...
  *another* EVA. I was in a pissy mood the whole time. Sweeping off a huge field of solar cels is boring and physicaly demanding. But
  ...
  I am one lucky son-of-a-bitch they aren’t freeze-dried or mulched. Why did NASA send 12 whole potatoes, refrigerated but not
  ...
  NASA was not fucking around with these emergency tents. The moment I pushed the panic button in the rover, there was an ear-
  ...
  During the most terrifying 23 minutes of my life, four of my crewmates and I tried not to shit ourselves while Martinez piloted the MDV
  ...
  lovely H2. During this process, it goes through an intermediate step of being ammonia. Chemistry, being the sloppy bitch it is, ensures
  ...
  Presuming I don’t fuck up with the Hydrazine, there’s stil the matter of burning hydrogen. I’m going to be setting a fire. In the Hab. On purpose.
  ...
  too much. There’s more shade and a cooler temperature near the Hab, but fuck that. If they’re going to blow up, they can blow up a rover, not my house.
  ...
  No not realy. I vented pure oxygen at the stick and gave it a spark. Fucker lit up like a match.
  ...
  So when I dip too low, I stop dicking with Hydrazine until I get the O2 back up to wel above 25L.
  ...
  extra layers of clothes. Fortunately I’m not a very big man. Martinez’s clothes fit over mine, and Vogel’s fit over Martinez’s. These shitty clothes were designed to be worn in a temperature-controled environment. Even with three layers, I was stil cold. I climbed in to my bunk and under the covers for more warmth.
  ...
  Then I inflated the bag with pure O2 from the suit’s tanks. “Holy shit!” the regulator thought, “I better pul O2 out right away!”
  ...
  medicine, bacteriology, nutrition analysis, explosion dynamics, or any other shit I’ve been doing lately, this is botany. I’m sure I can at least grow some plants without fucking up.
  ...
  Venkat returned to his office, dropped his briefcase on the floor, and colapsed into his leather chair. He took a moment to look out the windows at his scenic view of the Johnson Space Center.
  ...
  I finished making water some time ago. I’m no longer in danger of blowing myself up. The potatoes are growing nicely. Nothing has
  
  conspired to kil me in weeks. And ‘70’s TV keeps me disturbingly more entertained than it should. Things are stable here on Mars.
  
  It’s time to start thinking long term.
  
  Even if I find a way to tel NASA I’m alive, there’s no guarantee they’l be able to save me. I need to be proactive. I need to figure out how to get to Ares 4.
  
  Won’t be easy.
  
  Ares 4 wil be landing at the Schiapareli Crater, 3,200km away. In fact, their MAV is already there. I know because I watched
  
  Martinez land it.
  
  It takes 18 months for the MAV to make its fuel, so it’s the first thing NASA sends along. Sending it 48 months early gives it plenty of extra time in case fuel reactions go slower than expected. But much more importantly, it means a precision soft-landing can be done
  
  remotely by a pilot in orbit. Direct remote operation from Houston isn’t an option; they’re anywhere from 4 to 20 light-minutes away.
  
  Ares 4’s MAV spent 11 months getting to Mars. Using less fuel and taking a longer route, it got there around the same time as us. As
  
  expected, Martinez landed it beautifuly. It was one of the last things we did before piling in to our MDV and heading to the surface. Ahh, the good old days, when I had a crew with me.
  
  I’m lucky. 3,200km isn’t that bad. It could have been up to 10,000km away. And because I’m on the flattest part of Mars, the first
  
  650km is nice, smooth terrain (Yay Acidalia Planitia!) but the rest of it is nasty, rugged, crater-pocked hel.
  
  Obviously, I’l have to use a rover. And guess what? They weren’t designed for massive overland journeys.
  
  This is going to be a research effort, with a bunch of experimentation. I’l have to become my own little NASA, figuring out how to
  
  explore far from the Hab. The good news is I have lots of time to figure it out. Almost 4 years.
  
  Some stuff is obvious. I’l need to use a rover. It’l take a long time, so I’l need to bring supplies. I’l need to recharge en-route, and rovers don’t have solar cels. I’l need to steal some from the Hab’s solar farm. During the trip I’l need to breathe, eat, and drink.
  
  Lucky for me, the tech specs for everything are right here in the computer.
  
  I’l need to trick out a rover. Basicaly it’l have to be a mobile Hab. I’l pick Rover 2 as my target. We have a certain bond, after I
  
  spent two days in it during the “Great Hydrogen Scare of Sol 37.”
  
  There’s too much shit to think about al at once. So for now, I’l just think about power.
  
  Our mission had a 10km operational radius. Knowing we wouldn’t take straight-line paths, NASA designed the rovers to go 35km on
  
  a ful charge. That presumes flat, reasonable terrain. Each rover has a 9000Wh battery.
  
  Step one is to loot Rover 1’s battery and instal it in Rover 2. Ta-daa! I just doubled my ful-charge range.
  
  There’s just one complication. Heating.
  
  Part of the battery power goes to heating the rover. Mars is realy cold. Normaly, we were expected to do al EVAs in under 5 hours.
  
  But I’l be living in it 24½ hours a day. According to the specs, the heating equipment soaks up 400W. Keeping it on would eat up
  
  9800Wh per day. Over half my power supply, every day!
  
  But I do have a free source of heat: Me. A couple milion years of evolution gave me “warm blooded” technology. I can wear layers.
  
  The rover has good insulation, too. It’l have to be enough; I need every bit of power.
  ...
  According to my boring math, moving the rover eats 200Wh of juice to go 1km, so using the ful 18,000Wh gets me 90km of travel.
  
  Now we’re talkin’.
  
  I’l never actually get 90km on a single charge. I’l have hils to deal with, and rough terrain, sand, etc. But it’s a good balpark. It tels me that it would take at least 35 days of travel to get to Ares 4. It’l probably be more like 50. But that’s plausible, at least.
  
  At the rover’s blazing 25kph top speed, it’l take me 3½ hours before I run the battery down. I’d like to charge the battery up during
  
  the rest of the day. I can drive in twilight, and save the sunny part of the day for charging. This time of year I get about 13 hours of light.
  
  How many solar cels wil I have to pilfer from the Hab’s farm?
  
  Thanks to the fine taxpayers of America, I have over 100 of square meters of the most expensive solar paneling ever made. It has an
  
  astounding 10.2% efficiency, which is good because Mars doesn’t get as much sunlight as Earth. Only 500 to 700 watts per square meter
  ...
  I can put two stacks of 7 on the roof. They’l stick out over the edges, but as long as they’re secure I’m happy. Every day, after
  ...
  Sometimes things are easy, and sometimes they’re not. Getting the battery out of Rover 1 was easy. I removed two clamps on the
  
  undercarriage and it dropped right out. The cabling is easy to detach, too. It’s just a couple of complicated plugs.
  ...
  It’s just too big. There’s no room in the undercarriage for a second one. There’s no room on the roof, either. That’s where the solar
  
  cels wil go. There’s no room inside the cabin, and it wouldn’t fit through the airlock anyway.
  
  But fear not, I found a solution.
  
  For emergencies completely unrelated to this one, NASA provided 6 square meters of Hab canvas, and some realy impressive resin.
  
  The same kind of resin, in fact, that saved my life on Sol 6 (the patch kit I used on the hole in my suit).
  
  In the event of a Hab breach, everyone would run to the airlocks. Procedure was to let it pop rather than die trying to prevent it. Then, we’d suit up and assess the damage. Once we found the breach, we’d seal it with the spare Hab canvas and resin. Then re-inflate and
  ...
  I used the resin and straps to make two 10m circumference loops. Then I put a big patch of canvas on each end. I now had poor-
  ...
  I dragged the battery to the side of the rover and looped one end of the harness around it. Then I threw the other end over the roof. On the other side, I filed it with rocks. When the two weights were roughly equal, I was able to pul the rocks down and bring the battery up.
  
  Yay!
  
  Unplugging Rover 2’s battery, I plugged in Rover 1’s. Then I went through the airlock to the rover and checked al systems. Everything
  
  was a-ok.
  
  I drove the rover around a bit to make sure the harness was secure. I found a few large-ish rocks to drive over, just to shake things up.
  ...
  There’s no need to have a continuous power supply. When Battery 1 runs out, I can get out, unplug Battery 1 and plug in Battery 2.
  
  Why not? It’s a 10 minute EVA, once per day. I’d have to swap batteries again when charging, but again: so what?
  
  I spent the rest of the day sweeping off the solar cel farm. Soon, I shal be looting it.
  ...
  They’re thin, light, and just laying around on the ground. And I had one additional bonus: I was the one who set them up In the first
  
  place.
  
  Wel, ok. It wasn’t just me. Vogel and I worked together on it. And boy did we dril on it. We spent almost an entire week driling on the solar array alone. Then we driled more whenever they figured we had spare time. It had been deemed mission critical. If we fucked it up and broke the cels or rendered them useless, the Hab wouldn’t be able to make power, and the mission would end.
  
  You might wonder what the rest of the crew were doing. They were setting up the Hab. Remember, everything in my glorious kingdom
  
  came here in boxes. We had to set it up on Sols 1 and 2.
  
  Each solar cel is on a lightweight lattice that holds it at a 14 degree angle. I’l admit I don’t know why it’s a 14 degree angle. Something about maximizing solar energy. Anyway, removing the cels was simple. Then it was time to stack them on the rover.
  
  I considered removing the rock sample container. It’s nothing more than a large canvas bag attached to the roof. Way too smal to hold
  
  the solar cels. But after some thought I left it there, figuring It’l provide a good cushion.
  
  The cels stacked wel (they were made to, for transport to Mars), and the two stacks sat nicely on the roof. They hung over the left
  
  and right edges, but I won’t be going through any tunnels so I don’t care.
  
  With some more abuse of the emergency Hab material, I made straps and tied the cels down. The rover has external handles near the
  
  front and back. They’re there to help us load rocks on the roof. They made perfect anchor points for the straps.
  
  I stood back and admired my work. Hey, I earned it. It wasn’t even noon and I was done.
  
  I came back to the Hab, had some lunch, and worked on my crops for the rest of the sol. It's been 39 sols since I planted the potatoes
  
  (which is about 40 Earth days), and it was time to reap and re-sow.
  
  They grew even better than I had expected. Mars has no insects, parasites, or blights to deal with, and the Hab maintains perfect
  
  growing temperature and moisture at al times.
  
  They were smal compared to the taters you'd usualy eat, but that's fine. Al I wanted was enough to support growing new plants.
  
  I dug them up, being careful to leave their plants alive. Then I cut them up in to smal pieces with one eye each, and re-seeded in to new dirt. If they keep growing this wel, I'l be able to last a good long time here.
  
  After al that physical labor, I deserved a break. I rifled through Johanssen’s computer today, and found an endless supply of digital
  
  books. Looks like she’s a big fan of Agatha Christie. Beatles, Christie… I guess Johanssen’s an anglophile or something.
  
  I remember liking Hercule Poirot TV specials back when I was a kid. I’l start with The Mysterious Affair at Styles. Looks like that’s the first one.
  ...
  NASA gets to name their missions after gods and stuff, so why can’t I? Henceforth, rover experimental missions wil be “Sirius”
  
  missions. Get it? Dogs? Wel if you don’t, fuck you.
  
  Sirius 1 wil be tomorrow.
  
  The mission: Starting with fuly charged batteries, and having the solar cels on the roof, drive until I run out of power, and see how far I get.
  
  I won’t be an idiot. I’m not driving directly away from the Hab. I’l drive a half-kilometer stretch, back and forth. I’l be within a short walk of home al times.
  
  Tonight, I’l charge up both batteries so I can be ready for a little test drive tomorrow. I estimate 3½ hours of driving, so I’l need to bring fresh CO2 filters. And, with the heater off, I’l wear three layers of clothes.
  ...
  More accurately, Sirius 1 was aborted after 1 hour. I guess you could cal it a “failure” but I prefer the term “learning experience.”
  ...
  ground, which makes for abnormaly high energy efficiency. This is nothing like it would be on a long trip.
  ...
  I was fine for a while. My own body heat plus three layers of clothing kept me warm and the rover’s insulation is top-notch. The heat
  
  that escaped my body just warmed up the interior. But there’s no such thing as perfect insulation, and eventualy the heat left to the great outdoors while I got colder and colder.
  ...
  Once I got home, I sulked for a while. Al my briliant plans foiled by thermodynamics. Damn you, Entropy!
  
  I’m in a bind. The damn heater wil eat half my battery power every day. I could turn it down, I guess. Be a little cold but not freezing to death. Even then I’d stil lose at least a quarter.
  
  This wil require some thought. I have to ask myself… what would Hercule Poirot do? I’l have to put my “little gray cels” to work on
  ...
  I came up with a solution, but… remember when I burned rocket fuel in the Hab? This’l be more dangerous.
  ...
  Plutonium-238 is an incredibly unstable isotope. It’s so radioactive that it wil get red hot al by itself. As you can imagine, a material that can literally fry an egg with radiation is kind of dangerous.
  ...
  As long ago as the 1960’s, NASA’s been using RTGs to power unmanned probes. It has lots of advantages over solar power. It’s not
  
  affected by storms; it works day or night; it’s entirely internal, so you don’t need delicate solar cels al over your probe.
  
  But they never used large RTGs on manned missions until The Ares Program.
  
  Why not? It should be pretty fucking obvious why not! They didn’t want to put astronauts next to a glowing hot bal of radioactive
  
  death!
  
  I'm exaggerating a little. The Plutonium is inside a bunch of pelets, each one sealed and insulated to prevent radiation leakage even if the outer container is breached. So for the Ares Program, they took the risk.
  
  An Ares mission is al about the MAV. It’s the single most important component. It’s one of the few systems that can’t be replaced or
  
  worked around. It’s the only component that causes a complete mission scrub if it’s not working.
  
  Solar cels are great in the short-term, and they’re good for the long-term if you have humans around to clean them. But the MAV sits
  
  alone for years quietly making fuel, then just kind of hangs out until its crew arrives. Even doing nothing, it needs power, so NASA can monitor it remotely and run self checks.
  
  The prospect of scrubbing a mission because a solar cel got dirty was unacceptable. They needed a more reliable source of power. So
  
  the MAV comes equipped with an RTG. It has 2.6kg of Plutonium-238, which makes almost 1500 Watts of heat. It can turn that in to 100
  
  Watts of electricity. The MAV runs on that until the crew arrive.
  
  100 Watts isn’t enough to keep the heater going, but I don’t care about the electrical output. I want the heat. A 1500 Watt heater is so warm I’l have to tear insulation out of the rover to keep it from getting too hot.
  
  As soon as the rovers were un-stowed and activated, Commander Lewis had the joy of disposing of the RTG. She detached it from
  
  the MAV, drove 4 km away, and buried it. However safe it may be, it's stil a radioactive core and NASA didn't want it too close to their astronauts.
  
  The mission parameters don’t give a specific location to dump the RTG. Just “At least 4km away”. So I’l have to find it.
  
  I have two things working for me. First, I was assembling solar panels with Vogel when Commander Lewis drove off, and I saw she
  
  headed due south. Also, she planted a 3 meter pole with a bright green flag on it where she buried it. Green shows up extremely wel
  
  against the Martian terrain. It’s made to ward us off, in case we get lost on a rover EVA later on.
  
  So my plan is: Head south 4km, then search around til I see the green flag.
  
  Having rendered Rover 1 unusable, I’l have to use my Mutant Rover for the trip. I can make a useful test mission of it. I’l see how wel
  
  the battery harness holds up to a real journey, and how wel the solar cels do strapped to the roof.
  ...
  Commander Lewis had buried it atop a smal hil. She probably wanted to make sure everyone could see the flag, and it worked great!
  
  Except instead of avoiding it, I bee-lined to it and dug it up. Not exactly what she was going for.
  
  It’s a large cylinder with heat-sinks al around it. I could feel the warmth it gave off even through my suit’s gloves. That’s realy
  
  disconcerting. Especialy when you know the root cause of the heat is radiation.
  
  No point in putting it on the roof; my plan was to have it in the cabin anyway. So I brought it in with me, turned off the heater, then
  
  drove back to the Hab.
  
  In the 10 minutes it took to get home, even with the heater off, the interior of the rover became an uncomfortably hot 37C. The RTG
  
  would definitely be able to keep me warm.
  
  The trip also proved my rigging worked. The solar cels and extra battery stayed beautifuly in place while traversing 8km of random
  
  terrain.
  
  I declare Sirius 2 to be a successful mission!
  
  I spent the rest of the day vandalizing the interior of the rover. The pressure compartment is made of metal. Just inside that is insulation, which is covered by hard plastic. I used a sophisticated method to remove sections of plastic (hammer), then carefuly removed the solid
  
  foam insulation (hammer again).
  
  After tearing out some insulation, I suited up and took the RTG outside. Soon, the rover cooled down again, and I brought it back in. I
  
  watched as the temperature rose slowly. Nowhere near as fast as it had on my trip back from the burial site.
  
  I cautiously removed more insulation (hammer) and checked again. After a few more cycles of this, I had enough insulation torn out that
  
  the RTG could barely keep up with it. In fact, it was a losing battle. Over time, heat would slowly leech out. That’s fine. I can turn on the heater for short bursts when necessary.
  
  I brought the insulation pieces with me back in to the Hab. Using advanced construction techniques (duct tape) I reassembled some of
  
  it into a square. I figure if things got realy cold, I could tape that to a bare patch in the rover, and the RTG would be winning the “heat fight.”
  ...
  Today, I write to you from the rover. I’m halfway-through Sirius 3 and things are going wel.
  
  I set out at first light and drove laps around the Hab, trying to stay on untouched ground. The first battery lasted just under two hours.
  
  After a quick EVA to switch the cables, I got back to driving. When al was said and done, I had driven 81km in 3 hours and 27 minutes.
  
  That’s very good! Mind you, the land around the Hab is realy flat, as is al of Acidalia Planitia. I have no idea what my efficiency would be on the nastier land en route to Ares 4.
  
  I could have gone further, but I need life support while recharging. The CO2 gets absorbed through a chemical process, but if the fan
  
  that pushes it isn’t working, I’l choke. The oxygen pump is also kind of important.
  
  I set up the solar cels. It was hard work; last time I had Vogel’s help. They aren’t heavy, but they’re awkward. After setting up half of them, I figured out I could drag them rather than carry them and that sped things up.
  
  Now I’m just waiting for the batteries to recharge. I’m bored, so I’m updating the log. I have al the Poirot books in my computer.
  
  That’l help. It’s going to take 12 hours to recharge, after al.
  
  What’s that, you say? 12 hours is wrong? I said 13 hours earlier? Wel, my friend, let me set you straight.
  
  The RTG is a generator. It’s a paltry amount of power, compared to what the rover consumes, but it’s not nothing. It’s 100 Watts.
  
  It’l cut an hour off my total recharge time. Why not use it?
  
  I wonder what NASA would think about me fucking with the RTG like this. They’d probably hide under their desks and cuddle their
  ...
  Looks like power and battery recharging is solved. Food’s not a problem; there’s plenty of space to store things. Water’s even easier
  
  than food. I need 2L per day to be comfortable.
  
  In the long term, I’l need to bring the Oxygenator. But it’s big and I don’t want to screw with it right now. So I’l rely on O2 and CO2
  
  filters for Sirius 4.
  
  CO2 isn’t a problem. I started this grand adventure with 1500 hours of CO2 filters, plus another 720 for emergency use. Al systems
  
  use standard filters (Apolo 13 taught us important lessons). Since then, I’ve used 131 hours of filter on various EVAs. I have 2089 left. 87
  
  days worth. Plenty.
  
  The rover was designed to support 3 people for 2 days, plus some reserve for safety. So its O2 tanks can hold enough to last me 7
  
  days. Not enough.
  
  Mars has 1/90th Earth’s atmospheric pressure. The inside of the rover has 1 atmosphere. So the oxygen tanks are on the inside (less
  
  pressure differential to deal with). Why does that matter? It means I can bring along other oxygen tanks, and equalize them with the rover’s tanks without having to do an EVA.
  
  So today, I detached one of the Hab’s two 25L oxygen tanks and brought it in to the rover. According to NASA, a human needs
  
  588L of oxygen per day to live. Compressed liquid O2 is about 1000 times as dense as gaseous O2 in a comfortable atmosphere. Long
  
  story short: with the Hab tank, I have enough O2 to last 42 days. That’l be plenty.
  
  Sirius 4 wil be a 20 day trip.
  
  That may seem a bit long, but I have a specific goal in mind. Besides, my trip to Ares 4 wil be at least 40 days. This is a good scale
  
  model.
  
  While I’m away, the Hab can take care of itself, but the potatoes are an issue. I’l saturate the ground with most of the water I have.
  
  Then, I’l deactivate the Atmospheric Regulator, so it doesn’t pul water out of the air. It’l be humid as hel, and water wil condense on
  
  every surface. That’l keep the potatoes wel watered while I’m away.
  
  A bigger problem is CO2. The potatoes need to breathe. I know what you’re thinking. “Mark, old chap! YOU produce carbon
  
  dioxide! It’s al part of the majestic circle of nature!”
  
  The problem is: Where wil I put it? Sure, I exhale CO2 with every breath, but I don’t have any way to store it. I could turn off the
  
  Oxygenator and Atmospheric Regulator and just fil the Hab with my breath over time. But CO2 is deadly to me. I need to release a bunch
  
  at once and run away.
  
  Remember the MAV fuel plant? It colects CO2 from the Martian atmosphere. My smal crops aren’t nearly as needy as me, so a 10L
  
  tank of compressed liquid CO2, vented in to the Hab, wil be enough CO2 to do the trick. That’l take less than a day to create.
  
  So that’s everything. Once I vent the CO2 in to the Hab, I’l turn off the Atmospheric Regulator and Oxygenator, dump a ton of water
  ...
  “Helo, and thank you for joining us,” Cathy said to the camera. “Today on CNN’s Mark Watney Report: Several EVAs over the past
  ...
  “No,” Venkat frowned, “She gets a promotion cause she figured out he was alive. Stop being a dick, Mitch. You’re making her feel
  ...
  just need the solar cels cleaned. Even if it’s got a bigger problem, he’s an engineer!” Dialing, he added “Fixing shit is his job!”
  ...
  of time in space, you learn how to shit in a bag. And if you think things are bad after opening the piss box, imagine the smel after I drop anchor.
  ...
  After securing the cels, I come back in, turn on some shitty ‘70’s music, and start driving. I putter along at 25kph, the rover’s top
  ...
  I have shitty ‘70’s TV to watch, and a bunch of Poirot novels. But mostly I spend my time thinking about getting to Ares 4. I’l have to
  ...
  of shit, and personal items. I have a bunch of crew jumpsuits to serve as bedding, along with my blanket and pilow. Basicaly, I sleep in a pile of junk every night.
  ...
  I don’t know if I’ve mentioned this before, but I am realy fucking sick of being in this rover. I’ve spent so much time seated or laying down, my back is al screwed up. Of al my crewmates, the one I miss most right now is Beck. He’d fix my aching back.
  
  Though he’d probably give me a bunch of shit about it. “Why didn’t you do stretching exercises? Your body is important! Eat more
  ...
  I added my bags of shit to the manure pile. Lovely smel, I can tel you. But once I mixed some soil in, it died down to tolerable levels. I dumped my box o’ pee into the Water Reclaimer.
  ...
  “fuck you” from Mars to your lander. Eventualy it’s using more power to keep warm than it’s getting from the meager daylight that makes
  ...
  “I’m just the director,” Bruce said modestly. “Thank the guys who got al this shit working.”
  ...
  “I need something, Venkat,” Annie said. “You’ve been in contact for 24 hours and the media is going ape shit. They want an image for
  ...
  I have to be watching the camera when it spels shit out. It’s half a byte at a time. So I watch a pair of numbers, then look them up on
  ...
  “LNCHhexiditONRVRCMP,OPENFILE-/usr/lib/habcomm.so-SCROLLTILIDXON
  
  LFTIS:2AAE5,OVRWRT141BYTSWTHDATAWE’LLSNDNXTMSG,STANDINVIE W4NXTPIC20MINFTERTHSDONE”
  ...
  Watney slept peacefuly in his bunk. He shifted slightly as some pleasant dream put a smile on his face. The previous day had been
  ...
  The employees of Deyo Plastics worked double shifts. There was talk of triple shifts if NASA increased the order again. No
  ...
  awesome to have a bunch of dipshits on Earth teling me, a botanist, how to grow plants.
  ...
  the Hab. But hey, I can’t bitch. My odds of living through this are way higher now.
  ...
  856. It’l have plenty of food, a spare Oxygenator, Water Reclaimer, and comm system. Three comm systems, actualy. I guess they aren’t
  ...
  abandoned me on Mars you fuckwits!” I know the crew is surprised to hear from the Ghost of Mars Missions Past, but c’mon. I wish
  ...
  No, we will not tell our Botany Team to “Go fuck themselves.” I understand you’ve
  ...
  NASA, however, is absolutely shitting itself. They see the Water Reclaimer as a critical survival element. There’s no backup, and they
  ...
  Also, during the… whatever the fuck happened… I got bounced around like a pinbal and smashed my faceplate. Air is notoriously
  ...
  “I'm giving daily updates to the press,” she said. “Everyone knows Watney's fucked if this doesn't work. The public hasn't been this
  ...
  “Bulshit,” Mitch said. “You guys have done end-runs around the crew every time something goes wrong. You didn't tel them Watney
  ...
  “You god damned fucking coward,” Mitch continued, ignoring Venkat. “You just want to cut your losses. You're on damage control.
  ...
  “Bulshit!” Mitch shot back as he stood from his chair. “You're just convincing yourself the crash-lander wil work so you don't have to take a risk. You're hanging him out to dry, you chicken-shit son of a bitch!”
  ...
  “I know you care about the astronauts, but he's right. You are a fucking coward. If you had bals we might be able to save Watney.”
  ...
  emotion cloud her judgment, she'd be a shitty commander. And she's not a shitty commander.”
  ...
  The flyby is on Sol 549, so I'l need to leave by 449. That gives me 257 sols to get my shit in gear.
  ...
  NASA is stil working on the details, but the idea is to use both rovers. One to drive around, the other to act as a trailer for al the shit I have to bring.
  ...
  I managed to not kil myself today, even though I was working with high voltage. Wel, it's not as exciting as al that. I disconnected the line before I fucked with it.
  ...
  The rovers are made to interlock so one can tow the other. That way you can rescue your crewmates if the shit hits the fan. For that
  ...
  I've actualy exhausted Lewis's supply of shitty '70's TV. And I've read al of Johanssen's mystery books.
  ...
  6. Spel message in Morse Code with rocks, include things attempted. Problem may be recoverable with remote update of Pathfinder.
  ...
  per sol is... it can be anything... um... I suck at this... oh fuck it. I'l cal it a “pirate-ninja.”
  ...
  Oxygenator, of course. Rather than weigh al that shit, I took a guess and caled it 1200kg.
  ...
  That's too fucking long. I'l tear my own head off if I have to live in the rover that long. Anyway, I'm exhausted from lifting rocks and whining about lifting rocks. I think I puled something in my back. Gonna take it easy the rest of today.
  ...
  RTG anyway. A few more won't hurt. That's my bulshit rationalization and I'm sticking with it.
  ...
  I took hot baths twice a day, laid in my bunk a lot, and watched shitty '70's TV. I've already seen Lewis's entire colection, but I didn't have much else to do. I was reduced to watching reruns.
  ...
  This trip's power needs wil be driven by the Oxygenator. It al comes down to how much power I can give that greedy little fucker in a
  ...
  In other news, It occurred to me that NASA is probably shitting bricks. They're watching me with satelites, and haven't seen me come
  ...
  increase volume to decrease mass they were al over it. Mass is the expensive part about sending shit to Mars.
  ...
  screws up, the whole crew wil be in deep shit. I'm more nervous about that than anything else.
  ...
  “Better than nothing,” Lewis said. Floating in her quarters, she gently touched the bulkhead to stop drifting. “It's nice to see you in realtime for a change.”
  
  “Yeah,” Robert smiled. “I can hardly notice the delay. I gotta say, I wish you were coming home.”
  
  Lewis sighed, “Me too, babe.”
  
  “Don't get me wrong,” Robert quickly added, “I understand why you're doing al this. Stil, from a selfish point of view, I miss my wife.
  ...
  “An original production 8-track of Abba's Greatest Hits. Stil in the original packaging.”
  ...
  “At least we don't have to go to Jiuquan til tomorrow,” Venkat moaned. “14½ hours of flying is enough for one day.”
  
  “Don't get too comfortable,” Teddy said. “We stil have to go through customs and we'l probably have to fil out a bunch of forms
  ...
  Beijing Capital International Airport's Terminal 3 echoed with the cacophony common to huge air terminals. Venkat and Teddy
  
  continued forward as the Chinese citizens from their flight split off to go to a simpler point-of-entry process.
  
  As Venkat took his place in line, Teddy filed in behind him and scanned the terminal for a convenience store. Any form of caffeine
  
  would be welcome.
  
  “Excuse me, gentlemen,” came a voice from beside them.
  
  They turned to see a young Chinese man wearing casual attire. “My name is Su Bin Bao,” he said in perfect English. “I am an employee
  
  of the China National Space Administration. I wil be your guide and translator during your stay in the People's Republic of China.”
  ...
  “I can do better than that, Dr. Kapoor,” Su smiled. “You are official guests of the People's Republic of China. You have been pre-
  ...
  “Yes, thank you,” Teddy said. “The hospitality of your people has been wonderful. The private jet you arranged to bring us here was a
  
  nice touch.”
  
  “My people have enjoyed working with your advance team,” Guo Ming said. “The last month has been very interesting.
  
  Attaching an American probe to a Chinese booster. I believe this is the first time it's ever been done.”
  
  “It just goes to show,” Teddy said. “Love of science is universal across al cultures.”
  
  Guo Ming nodded. “My people have especially commented on the work ethic of your man Mitch Henderson. He is very
  ...
  “In case the probe can't dock with us. If something goes wrong, it'l be my job to go out and grab it . ”
  ...
  “I am,” Beck said. “Everyone has multiple roles. I'm the doctor, the biologist, and the EVA specialist. Commander Lewis is our
  ...
  “It al checks out,” Mitch said. “JPL folowed the specs perfectly. It fits like a glove.”
  ...
  “Fair enough. So long as the probe gets to Hermes, they can burn me in fucking effigy for al I care.”
  ...
  “Just think of the playground cred he'l have later in life,” she said. “'My dad went to Mars. What's your dad do?'”
  
  “Yes, I'm pretty awesome,” he agreed.
  
  Marissa continued to wave David's hand at the camera. David was more interested in his other hand, which was actively engaged in
  ...
  “Your son wil be in kindergarten when you get back. He won't have any memories of you.”
  ...
  “Welcome to CNN's Mark Watney Report. Today we have the Director of Mars Operations Venkat Kapoor. He's speaking to us live
  
  via satelite from China. Dr. Kapoor, thank you for joining us.”
  
  “Happy to do it,” Venkat said.
  
  “So Dr. Kapoor, tel us about the Taiyang Shen. Why go to China to launch a probe? Why not launch it from the US?”
  ...
  “It was a rush job,” Venkat said. “JPL only had 30 days to put it together. They had to be as safe and efficient as they could. It's
  
  basicaly a shel ful of food and other supplies. It has a standard satelite thruster package for maneuvering, but that's it.”
  
  “And that's enough to fly to Hermes?”
  
  “The Taiyang Shen wil send it to Hermes. The thrusters are for fine control and docking. And JPL didn't have time to make a
  
  guidance system. So it'l be remote-controled by a human pilot.”
  
  “Who wil be controling it?” Cathy asked.
  
  “The Ares 3 pilot, Major Rick Martinez. As the probe approaches Hermes, he'l take over and guide it to the docking port.”
  
  “And what if there's a problem?”
  
  “Hermes wil have their EVA specialist, Dr. Chris Beck, suited up and ready the whole time. If necessary he wil literaly grab the probe
  
  with his hands and drag it to the docking port.”
  
  “Sounds kind of unscientific,” Cathy laughed.
  
  “You want unscientific?” Venkat smiled. “If the probe can't attach to the docking port for some reason, Beck wil open the probe and
  
  carry its contents to the airlock.”
  
  “Like bringing in the groceries?” Cathy asked.
  
  “Exactly like that,” Venkat said. “And we estimate it would take 4 trips back and forth. But that's al an edge case. We don't anticipate any problems with the docking process.”
  
  “Sounds like you're covering al your bases,” Cathy smiled.
  
  “We have to,” Venkat said. “If they don't get those supplies... wel, they need those supplies.”
  ...
  He fidgeted in the chair, unsure what to say. After a moment, he puled a handkerchief from his pocket and mopped sweat from his
  ...
  “She can't eat, she can't sleep, she feels sick al the time. I'm not much better. How can they make you do this?”
  ...
  “You were always scientificaly minded,” he said. “It was great! Straight-A student. Hanging around nerdy guys too scared to try
  
  anything. No wild side at al. You're every father's dream daughter.”
  
  “Thanks, Dad, I-”
  
  “But then you got on a giant bomb that blasted you to Mars. And I mean that literaly.”
  
  “Technicaly,” she corrected, “the booster only took me in to orbit. It was the nuclear powered ion engine that took me to Mars.”
  
  “Oh, much better!” He said.
  
  “Dad, I'l be al right. Tel Mom I'l be al right.”
  
  “What good wil that do?” He said. “She's going to be tied up in knots until you're back home.”
  ...
  “Look,” he said, leaning toward the camera. “I've always respected your privacy and independence. I never tried to pry in to your life,
  
  never tried to control you. I've been realy good about that, right?”
  
  “Yeah,” she said.
  
  “So in exchange for a lifetime of staying out of your business, let me nose in just this once. What are you not teling me?”
  ...
  “They picked me to survive. I'm youngest. I have the skils necessary to get home alive. And I'm the smalest and need the least food.”
  
  “What happens if the probe fails, Beth,” her father asked. This time, he was uncharacteristicaly firm.
  
  “Everyone would die but me,” she said. “They'd al take pils and die. They'l do it right away so they don't use up any food.
  
  Commander Lewis picked me to be the survivor. She told me about it yesterday. I don't think NASA knows about it.”
  
  “And the supplies would last until you got back to Earth?”
  
  “No,” she said. “We have enough food left to feed six people for a month. If I was the only one, it would last 6 months. With a reduced
  ...
  Taiyang Shen's con-trail wafted in the chily Gobi sky. The ship, no longer visible to the naked eye, pressed onward toward orbit. Its deafening roar dwindled to a distant rumbling thunder.
  ...
  “In the end, we built a beautiful probe. The largest, sturdiest unmanned probe in history. And now it's sitting in a warehouse. It'l never fly. The State Council won't fund another booster like that.”
  
  He turned to Venkat. “It could have been a lasting legacy of scientific research. Now it's a delivery run. We'l get a Chinese astronaut
  
  on Mars, but what science wil he bring back that some other astronaut couldn't have? This operation is a net loss for mankind's
  ...
  “No problem,” Martinez said, his eyes glued to his screens. One showed the camera feed from docking port A, the other a constant
  
  feed of the probe's telemetry.
  
  Lewis floated behind Johanssen and Martinez's stations.
  
  “Visual contact,” Beck's voice came over the radio. He stood in Airlock 3 (via magnetic boots), fuly suited up with the outer door
  
  open. The bulky SAFER Unit on his back would alow him free motion in space should the need arise. An attached tether led to a spool on
  
  the wal.
  
  “Vogel,” Lewis said in to her headset. “You in position?”
  
  Vogel stood in the stil-pressurized Airlock 2, suited up save his helmet. “Ja, in position and ready,” he replied. He was the emergency
  ...
  The probe drifted gently to the docking port. Its capture boom, a long metal triangle, entered the port's funnel, scraping slightly along the edge. The port puled the boom in, aligning and orienting the probe automaticaly. After several loud clanks echoed through the ship, the computer reported success.
  ...
  “Glad to hear it, Hermes,” came Mitch's voice over the comm. “Report status of al supplies once you get them aboard and inspected.”
  
  “Roger Jiuquan,” Lewis said.
  
  Taking off her headset, she turned to Martinez and Johanssen. “Unload the probe and stow the supplies. I'm going to help Beck and
  ...
  I plan to leave for Schiapareli 100 sols before my rescue (or death), and I swear to fucking God I'l rip my own face off if I have to live in the rover for that long.
  ...
  shapes of canvas I'l need. I needed to not fuck this up, so I triple-checked everything. I even made a model out of paper.
  ...
  The fourth one is “Survived Something That Should Have Kiled Me” because some fucking thing wil happen, I just know it. I don't
  
  know what it'l be, but it'l happen. The rover wil break down or I'l come down with Fatal Hemorrhoids or I'l run in to hostile Martians or some shit. When I do (if I live) I get to eat that meal pack.
  ...
  It's been a long, physicaly taxing day. I'm totaly exhausted but I can't sleep. Every sound scares the shit out of me. Is that the Hab
  ...
  Since Sol 6 al I've wanted to do was get the hel out of here. Now the prospect of leaving the Hab behind scares the shit out of me. I
  ...
  I have two pressure vessels: The rover and the trailer. They're connected by hoses, but they're also not stupid. If one loses pressure,
  
  the other wil instantly seal off the shared lines.
  
  There's a grim logic to this: If the rover breaches I'm dead. No point in planning around that. But if the trailer breaches, I'l be fine. That means I should put everything important in the rover. If I'm going to die, I may as wel take al the delicate stuff with me.
  
  Everything that goes in the trailer has to be comfortable in near-vacuum and freezing temperatures. Not that I anticipate that, but you
  
  know. Plan for the worst.
  
  There isn't much room to spare. It'l have two bulky Hab batteries, the Atmospheric Regulator, the Oxygenator and my home-made
  
  heat reservoir. It would be more convenient to have the reservoir in the rover, but it has to be near the Regulator's return air feed.
  
  It'l be cramped, but there wil be some empty spaces. And I know just how to fil them: Taters!
  
  Nothing “bad” can happen to the potatoes. They're already dead. I've been storing them outside for months anyway. Also, they're smal
  
  and not delicate. They probably won't al fit, so some wil have to ride with me.
  
  The rover wil be pretty packed, too. When I'm driving, I'l keep the bedroom folded up near the airlock, ready for emergency egress.
  
  Also, I'l have the two functional EVA suits in there with me and anything that might be needed for emergency repairs: Tool kits, spare
  
  parts, my nearly depleted supply of sealant, the other rover's main computer (just in case!) and al 620 glorious liters of water.
  ...
  “Uh, yeah,” Mindy said, typing on her keyboard. “I noticed things would always change around 9am local time. People usualy keep
  
  the same patterns so I figured he likes to start work around then. I did some minor realignment to get seventeen pics between 9:00 and
  ...
  “Wel it is a photo taken from orbit,” Mindy said. “The NSA enhanced the image with the best software they have.”
  
  “Wait, What?” Venkat stammered. “The NSA?”
  
  “Yeah, they caled and offered to help out. Same software they use for enhancing spy satelite imagery.”
  
  Venkat shrugged. “It's amazing how much red tape gets cut when everyone's rooting for one man to survive.” He pointed to the screen.
  ...
  Venkat shrugged. “He's busy. He works most of the daylight hours, and arranging rocks to spel a message takes time and energy.”
  
  “So...” Mindy said. “Why'd you come here in person? We could have done al this over email.”
  
  “Actualy, I came to talk to you,” he said. “There's going to be a change in your responsibilities. From now on, instead of managing the
  ...
  “We'l assign that to other people,” Venkat said. “From now on, your only focus is examining imagery of Ares 3.”
  
  “That's a demotion,” Mindy said. “I'm an orbital engineer, and you're turning me in to a glorified Peeping Tom.”
  
  “It's short-term,” Venkat said. “And we'l make it up to you. Thing is, you've been doing it for months and you're an expert at
  
  identifying elements of Ares 3 from satelite pics. We don't have anyone else who can do that.”
  
  “Why is this suddenly so important?”
  
  “He's running out of time,” Venkat said. “We don't know how far along he is on the rover modifications. But we do know he's on only
  
  got 16 sols to get them done. We need to know exactly what he's doing. I've got media outlets and senators asking for his status al the
  
  time. The President even caled me a couple of times.
  
  “But seeing his status doesn't help,” Mindy said. “It's not like we can do anything about it if he fals behind. This is a pointless task.”
  ...
  This presents a problem. Unlike my Pathfinder trip, I have to take vital life support elements out of the Hab. When you take the
  
  Atmospheric Regulator and Oxygenator out of the Hab, you're left with... a tent. A big round tent that can't support life.
  
  It's not as risky as it seems. As always, the dangerous part about life support is managing carbon dioxide. When the air gets to 1%
  
  CO2, you start getting symptoms of poisoning. So I need to keep it below that.
  
  The Hab's internal volume is about 120,000L. Breathing normaly, it would take me over two days to bring the CO2 level up to 1%
  
  (and I wouldn't even dent in the O2 level). So it's safe to move the Regulator and Oxygenator over for a while.
  
  Both are way too big to fit through the trailer airlock. Lucky for me, they came to Mars with “some assembly required”. They were too
  
  big to send whole, so they're easy to dismantle.
  
  Over several trips, I took al their chunks to the trailer. I brought each chunk in through the airlock, one at a time. It was a pain in the ass reassembling them inside, let me tel you. There's barely enough room for al the shit it's got to hold. There wasn't much left for our intrepid hero.
  
  Then I got the AREC. It sat outside the Hab like an AC unit might on Earth. In a way, that's what it was. I hauled it over to the trailer and lashed it to the shelf I'd made for it. Then I hooked it up to the feed lines that led through the “baloon” to the inside of the trailer's pressure vessel.
  
  The Regulator needs to send air to the AREC then the return air needs to bubble through the heat reservoir. And, it needs a pressure
  
  tank to dump the CO2 it puls from the air.
  
  When gutting the trailer to make room, I left one tank in place for this. It's supposed to hold oxygen, but a tank's a tank. Thank God al the air lines and valves are standardized across the mission. That's no mistake. It's a deliberate decision for maintenance purposes. We could fix things in the field easier that way.
  
  Once everything assembled, I hooked them in to the trailer's power and watched them power up. I ran both through ful diagnostics to
  
  confirm they were working correctly. Then I shut down the Oxygenator. Remember, I'l only use it one sol out of every 5.
  
  I moved to the rover, which means I had to do an annoying 10-meter EVA. From there I monitored the life support situation. It's worth
  
  noting that I can't monitor the actual support equipment from the rover (it's al in the trailer), but the rover can tel me al about the air.
  ...
  I left the equipment running when I returned to the Hab. It'l be on its own al night and I'l check it in the morning. It's not a true test, because I'm not there to breathe up the oxygen and make CO2, but one step at a time.
  ...
  Last night was weird. I knew logically that nothing bad would happen in just one night, but it was a little unnerving to know I had no life support other than heaters. My life depended on some math I did earlier. If I dropped a sign or added two numbers wrong, I might
  ...
  I checked up on the rover. Everything was fine. If I don't drive it, a single charge of the batteries could keep the regulator going for over a month (with the heater off). It's a pretty good safety margin to have. If al hel breaks loose on my trip I'l have time to fix things. I'd be limited by oxygen consumption rather than CO2 removal, and I have plenty of oxygen.
  ...
  As intended, the pressure from the rover blasted the canvas outward and inflated it. After that, chaos. The sudden pressure popped the
  
  bedroom like a baloon. It quickly deflated, leaving both itself and the rover devoid of air. I was wearing my EVA suit at the time; I'm not a fucking idiot. So I get to...
  
  Live Another Sol! (Starring Mark Watney as … probably Q. I'm no James Bond.)
  
  I dragged the popped bedroom in to the Hab and gave it a good going-over. It failed at the seam where the wal met the ceiling. Makes
  
  sense. It's a right-angle in a pressure vessel. Physics hates that sort of thing.
  
  First, I patched it up, then I cut strips of spare canvas to place over the seam. Now it has double-thickness and double sealing resin al around. Maybe that'l be enough. At this point, I'm kind of guessing. My amazing botany skils aren't much use for this.
  ...
  So it took a little longer for me to wake up this morning, and I spent most of the day with a headache. One nice thing about living in a multi-bilion dolar mansion on Mars: Access to pure oxygen. For some reason, a high concentration of O2 wil kil most headaches. Don't
  
  know why. Don't care. The important thing is I don't have to suffer.
  
  I tested out the bedroom again. I used the same process as yesterday. This time it held. So is that good? I don't know. That's the shitty part of failure analysis. If the bedroom fails while I'm sleeping in it, I'l die. How long wil it last?
  
  Hopefuly, if it developed a leak, it'd be slow enough that I could react. But you never know.
  
  After a few minutes standing around in my EVA suit, I decided to make better use of my time. I may not be able to leave while the
  
  bedroom is attached to the airlock, but I can go in to the rover and close the door.
  
  Once I did that, I took off the uncomfortable EVA suit. The bedroom was on the other side of the airlock door, stil fuly pressurized.
  ...
  I spent my time planning the trip. There wasn't much to add to what I already knew. I'l bee-line to Mawrth Valis, then folow it until it ends. It'l take me on a zig-zag route, but mostly toward Schiapareli.
  
  After that comes Arabia Terra. Each crater represents two brutal elevation changes. First down, then up. I did my best to find the
  
  shortest path around them. I'm sure I'l have to adjust the course when I'm actualy driving it. No plan survives first contact with the enemy.
  
  
  
  
  
  Mitch took his seat in the conference room. The usual gang was there: Teddy, Venkat, Mitch, and Annie. But this time there was also
  ...
  “Uh, yeah,” Mindy said. “Looks like Watney finished the baloon addition to the trailer. It mostly uses the design we sent him.”
  ...
  “We think it's a workshop,” Venkat said. “There'l be a lot of work to do on the MAV once he gets to Schiapareli. It'l be easier
  ...
  “It's the external component of the Atmospheric Regulator,” Mindy said. “It sits outside the Hab, so I know when it disappeared. He
  
  probably mounted it on the rover. There's no other reason to move it so I'm guessing he's got life support online.”
  
  “Awesome,” Mitch said. “Things are coming together.”
  
  “Don't celebrate yet, Mitch,” Venkat said. “This is Randal Carter, one of our Martian meteorologists. Randal, tel them what you told
  
  me.”
  
  Randal nodded. “Thank you, Dr. Kapoor.” He turned his laptop around to show a map of Mars. “Over the past few weeks, a dust
  
  storm has been developing in Arabia Terra. Not a big deal in terms of magnitude. It won't hinder his driving at al.”
  
  “So what's the problem?” Annie asked.
  
  “It's a low-velocity dust storm,” Randal Explained. “Slow winds, but fast enough to pick up very smal particles on the surface and
  
  whip them up in to thick clouds. There are five or six of them every year. The thing is, they last for months, they cover huge sections of the planet, and they make the atmosphere thick with dust.”
  
  “I stil don't see the problem,” Annie said.
  
  “Light,” Randal said. “The total sunlight reaching the surface is very low in the area of the storm. Right now, it's 20% of normal. And
  ...
  “The current plan already has him recharging al day long,” Venkat explained. “With 20% of normal daylight, it'l take five times as long
  
  to get the same energy. It'l turn his 45 sol trip in to 225 sols. He'l miss the Hermes flyby.”
  
  “Can't Hermes wait for him?” Annie asked.
  
  “It's a flyby,” Venkat said. “Hermes isn't going in to Martian orbit. If they did, they wouldn't be able to get back. They need their
  
  velocity for the return trajectory.”
  
  After a few moments of silence, Teddy said “We'l just have to hope he finds a way through. We can track his progress and-”
  
  “No we can't,” Mindy interrupted.
  
  “We can't?” Teddy said.
  
  She shook her head. “The satelites won't be able to see through the dust. Once he enters the affected area, we won't see anything until
  ...
  And not the little tests I've been doing so far. Sure, I've tested power generation, life support, the trailer bubble, and the bedroom. But I need to test al aspects of it working together.
  
  I'm going to load it up for the long trip, and drive in circles. I won't ever be more than 500 meters from the Hab, so I'l be fine if shit breaks.
  
  I dedicated today to loading up the rover and trailer for the test. I want the weight to match what it'l be on the real trip. Plus if cargo is going to shift around or break things I want to know about it now.
  
  I made one concession to common sense: I left most of my water supply in the Hab. I loaded 20 liters; enough for the test but no more.
  
  There are a lot of ways I could lose pressure in this mechanical abomination I've created, and I don't want al my water to boil off if that happens.
  ...
  Back on Earth, universities and governments are wiling to pay milions to get their hands on Mars rocks. I'm using them as balast.
  
  I'm doing one more little test tonight. I made sure the batteries were good and ful, then disconnected the rover and trailer from Hab
  
  power. I'l be sleeping in the Hab, but I left the rover's life support on. It'l maintain the air overnight, and tomorrow I'l see how much power it ate up. I've watched the power consumption while it's attached to the Hab and there weren't any surprises. But this'l be the true proof. I cal it the “Plugs-out test.”
  ...
  “Let's get through status quickly,” Lewis said. “We're al behind in our science assignments. Vogel, you first.”
  
  “I repaired the bad cable on VASIMR 4,” Vogel reported. “It was our last thick gauge cable. If another such problem occurs, we wil
  
  have to braid lower gauge lines to carry the current. Also, the power output from the reactor is declining.”
  
  “Johanssen,” Lewis said. “What the deal with the reactor?”
  
  “I had to dial it back,” Johanssen said. “It's the cooling vanes. They aren't radiating heat as wel as they used to. They're tarnishing.”
  
  “How can that happen?” Lewis asked. “They're outside the craft. There's nothing for them to react with.”
  
  “I think they picked up dust or smal air leaks from Hermes itself. One way or another, they're definitely tarnishing. The tarnish is
  
  connecting the micro-lattice, and that reduces the surface area. Less surface area means less heat dissipation. So I limited the reactor enough that we weren't getting positive heat.”
  
  “Any chance of repairing the cooling vanes?”
  
  “It's on the microscopic scale,” Johanssen said. “We'd need a lab. Usualy they replace the veins after each mission.”
  ...
  “Limping,” Beck said. “We've been in space way longer than it was designed to handle. There are a bunch of filters that would normaly
  
  be replaced each mission. I found a way to clean them with a chemical bath I made in the lab, but it eats away at the filters themselves.
  
  We're ok right now, but who knows what'l break next?”
  
  “We knew this would happen,” Lewis said. “This ship is designed for a 396 day mission, and we need to make it last 898. We've got
  
  al of NASA to help when things break. We just need to stay on top of maintenance. Martinez, what's the deal with your bunkroom?”
  
  Martinez furrowed his brow. “It's stil trying to cook me. The climate control just isn't keeping up. I think it's the tubing in the wals that brings the coolant. I can't get at them because they're built in to the hul. We can use the room for storage of non-temperature-sensitive cargo, but that's about it.”
  ...
  “I can't think of anywhere else to sleep,” he said. “The ship is pretty cramped, and if I sleep in a halway I'l be in people's way.”
  ...
  I'm getting pretty good at this. Maybe when al this is over I could be a product-tester for Mars rovers.
  
  Things went wel. I spent five sols driving in circles; I averaged 93 km per sol. That's a little better than I'd expected. The terrain here is flat and smooth, so it's pretty much a best-case scenario. Once I'm going up hils and around boulders it won't be nearly that good.
  
  The bedroom is awesome. Large, spacious, and comfortable. On the first night, I ran in to a little problem with the temperature. It was
  
  fucking cold. The rover and trailer regulate their own temperatures just fine, but things weren't hot enough in the bedroom.
  
  Story of my life.
  
  The rover has an electric heater that pushes air with a smal fan. I don't use it for anything because the RTG provides al the heat I need.
  
  I liberated the fan and wired it in to a power line near the airlock. Once it had power al I had to do was point it at the bedroom.
  ...
  I fel in to a routine pretty quickly. In fact, it was hauntingly familiar. I did it for 22 miserable days on the Pathfinder trip. But this time, I had the bedroom and that makes al the difference. Instead of being cooped up in the rover, I have my own little Hab.
  
  The procedure is what you'd expect. After waking up, I have a potato for breakfast. Then, I deflate the bedroom from the inside. It's
  
  kind of tricky, but I worked out how.
  
  First, I put on an EVA suit. Then I close the inner airlock door, leaving the outer door (which the bedroom is attached to) open. This
  
  isolates the bedroom, with me in it, from the rest of the rover. Then I tel the airlock to depressurize. It thinks it's just pumping the air out of a smal area, but it's actualy deflating the whole bedroom.
  
  Once the pressure is gone, I pul the canvas in and fold it. Then I detach it from the outer hatch and close the outer door. This is the
  
  most cramped part. I have to share the airlock with the entire folded up bedroom while it repressurizes. Once I have pressure again, I open the inner door and more-or-less fal in to the rover. Then I stow the bedroom, and go back to the airlock for a normal egress to Mars.
  
  It's a complicated process, but it detaches the bedroom without having to depressurize the rover cabin. Remember, the rover has al my
  
  stuff that doesn't play wel with vacuum.
  
  The next step is to gather up the solar cels I'd laid out the day before and stow them on the rover and trailer. Then I do a quick check on the trailer. I go in through its airlock and basicaly take a quick look at al the equipment. I don't even take off my EVA suit. I just want to make sure nothing's obviously wrong.
  ...
  Even though it's possible, I don't rapid-inflate the bedroom. I did that to test it because I wanted to find where it'l leak. But it's not a good idea. Rapid inflation puts a lot of shock and pressure on it. It would eventualy rupture. I didn't enjoy that time the Hab launched me like a cannonbal. I'm not eager to repeat it.
  
  Once the bedroom is set up again, I can take off my EVA suit and relax the rest of the day. I mostly watch crappy 70's TV. I'm
  ...
  An Air Day turns out to be pretty much the same as any other day, but without the 4 hour drive. Once I set up the solar panels, I fired
  
  up the Oxygenator and let it work through the backlog of CO2 the Regulator had stored up.
  
  Once it was done, my test run was complete. It converted al the CO2 to oxygen, and used up the day's power generation to do it.
  ...
  The rover and trailer are al packed. They've been mostly packed since the test run. But now I even have the water aboard.
  
  I spent the last several days running ful diagnostics on everything. The Regulator, Oxygenator, RTG, AREC, batteries, rover life
  
  support (in case I need a backup), solar cels, rover computer, airlocks, and everything else with a moving part or electronic component. I even checked each of the motors. Eight in al, one for each wheel, four on the rover, four on the trailer. The trailer's motors won't be
  
  powered, but it's nice to have backups.
  
  It's al good to go. No problems that I can see.
  
  The Hab is a shel of its former self. I've robbed it of al critical components and a big chunk of its canvas. I've looted that poor Hab for everything it could give me, and in return it's kept me alive for a year and a half. It's like The Giving Tree.
  
  I performed the final shutdown today. The heaters, lighting, main computer, etc. Al the components I didn't steal for the trip to
  
  Schiapareli.
  
  I could have left them on. It's not like anyone would care. But the original procedure for Sol 31 (which was supposed to be the last day of the surface mission) was to completely shut down the Hab and deflate it. NASA didn't want a big tent ful of combustible oxygen next to the MAV when it launched, so they added the shutdown process to the mission.
  
  I guess I did it as an homage to the mission Ares 3 could have been. A smal piece of the Sol 31 I never got to have.
  
  Once I shut everything down, an eerie silence was al that remained. I've spent 449 sols listening to the heaters, vents, and fans. But
  
  now it was dead quiet. It's a creepy, eerie kind of quiet that's hard to describe. I've been away from the Hab before, but always in the rover or an EVA suit. There's always some kind of machinery in operation.
  
  But now there was nothing. I never realized how utterly silent Mars is. It's a desert world with practicaly no atmosphere to convey
  
  sound. I could hear my own heartbeat.
  
  Anyway, enough waxing philosophical.
  
  I'm in the rover right now. (That should be obvious, with the Hab main computer offline forever.) I've got 2 ful batteries, al systems are go and I've got 45 sols of driving ahead of me.
  ...
  Making a sextant isn't hard. Al you need is a tube to look through, a string, a weight, and something with degree markings. I made it in under an hour.
  
  So I go out every night with a home-made sextant and sight Deneb. It's kind of sily if you think about it. I'm in my space suit on Mars
  ...
  Now things get tricky. In Acidalia Planitia, if I got off-course, I could just point in the right direction based on new data. Later, in Mawrth Valis, it was impossible to fuck it up. I just had to folow the canyon.
  ...
  “I know,” he said. “I'm not talking about faith in God, I'm talking about faith in Mark Watney. Look at al the shit Mars has thrown at
  
  him, and he's stil alive. He'l survive this. I don't know how, but he wil. He's a clever son-of-a-bitch.”
  ...
  I'm in the middle of a bunch of craters that form a triangle. I'm caling it the Watney Triangle because after what I've been through, shit on Mars should be named after me.
  ...
  around Marth Crater. Now I'm going to have to go around something a fuckload bigger.
  ...
  minute conversation with NASA. Now that I think of it, NASA must be shitting bricks watching this play out.
  ...
  The storm is probably circular. They usualy are. But I could just be driving in to an alcove. If that's the case, I'm just fucking dead, ok?
  ...
  If there were no storm, I'd be going directly southwest toward my goal. As it is, going only south, I'm not nearly as fast. I'm traveling 90km per day as usual, but I only get 37km closer to Schiapareli because Pythagoras is a dick. I don't know when I'l finaly clear the
  ...
  perpendicular to my direction of travel, it means I'm south of the southernmost point of the cloud (presuming it's a circular storm. If it's not then fuck.)
  ...
  Mind you, it hasn't been that bad. I'm wel in to Terra Meridiani now, and the driving is a little easier here than the rugged ass-kicking terrain of Arabia Terra. Schiapareli is almost due east, and if my sextant and Phobos calculations are correct, I've got another 1030km to get there.
  ...
  Holy shit. I just realized I actualy believe I'l get to the MAV. See what I did there? I casualy talked about what I'l do after I get to the MAV. Like it was nothing. No big deal. I'm just going to pop over to Schiapareli and hang with the MAV there.
  ...
  The trailer has tons of space. I put a fuckton of work in to making that happen. The baloon gives plenty of headroom. Not a lot of floor space, but stil lots of vertical area.
  ...
  Also, since the trailer detached there's a good chance it's fucked up, too. The baloon roof it has isn't exactly durable. If it popped, the shit inside wil have flung out in al directions and I'l have to go find it. That's my critical life support.
  ...
  Wel, that's not true. The tow hook is fucked beyond repair. Half of it ripped clean off. Fortunately, the trailer also has a tow hook, so I have a spare.
  ...
  And now I'm out of daylight again. I can't wait to get out of this fucking shadow. Al I need is one day of driving toward the MAV and
  
  I'l be away from the wal. But for now, it's another early night.
  
  I'l spend tonight without the trailer to manage my life support. It may be righted, but I have no idea if the shit inside stil works. The rover stil has ample supplies for me.
  ...
  shit, the MAV is a sleek, perfectly functional machine, ready to do what it's told. And they have it pretending to be the Ares 3 Hab so my rover wil see the signal and tel me where it is.
  ...
  My message for the day was “GOT BEACON SIGNAL.” If I'd had enough rocks, I would have added “AWESOME FUCKING
  ...
  miss the days when I made al the decisions myself. Then I shake it off and remember I'm infinitely better with a bunch of geniuses deciding what I do than making shit up as I go along.
  ...
  It might not launch at al. I did remove an engine, after al. I could have fucked up al sorts of things during that process. And there's no way to test the ascent stage. Once you light it, it's lit.
  ...
  Mission Day 687 up here. And you know what? It doesn't matter what time it is on Mars cause I'M NOT FUCKING THERE!
  ...
  times if needed. It'd be a pretty shitty long-range ship if it couldn't recover from a decompression.
  ...
  So now I'm waiting for the drugs to kick in. My ribs hurt like hel, my vision is stil blurry from acceleration sickness, I'm realy hungry, it'l be another 211 days before I'm back on Earth, and apparently I smel like a skunk took a shit on some sweat socks.
